...
export default class extends BaseSchema {
  protected tableName = 'bets_classic'
  ...
  async up() {
    this.schema.createTable(this.tableName, (table) => {
      ...
      table.uuid('favorite_rider_id').notNullable().references('id').inTable('riders').onDelete('RESTRICT')
      table.uuid('bonus_rider_id').notNullable().references('id').inTable('riders').onDelete('RESTRICT')
